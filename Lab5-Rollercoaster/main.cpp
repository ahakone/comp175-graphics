...
void myGlutDisplay(void)
{
	...
	if(followCoaster==1){
		...
		// gluLookAt(mySpline->getComputedX(coasterCar1Position) + .01, 
		// 			mySpline->getComputedY(coasterCar1Position) + .01, 
		// 			mySpline->getComputedZ(coasterCar1Position) + .01,
		// 			mySpline->getComputedX(coasterCar1Position + 1), 
		// 			mySpline->getComputedY(coasterCar1Position + 1), 
		// 			mySpline->getComputedZ(coasterCar1Position + 1),
		// 			0, 1, 0);
		// gluLookAt(mySpline->getComputedX(coasterCar1Position) + .01, 
		// 			mySpline->getComputedY(coasterCar1Position) + .01, 
		// 			mySpline->getComputedZ(coasterCar1Position) + .01,
		// 			mySpline->getComputedX(coasterCar1Position + 1) + .01, 
		// 			mySpline->getComputedY(coasterCar1Position + 1) + .01, 
		// 			mySpline->getComputedZ(coasterCar1Position + 1) + .01,
		// 			0, 1, 0);
		gluLookAt(mySpline->getComputedX(coasterCar1Position) - splineSize*.5, 
                          mySpline->getComputedY(coasterCar1Position), 
                          mySpline->getComputedZ(coasterCar1Position),
                          mySpline->getComputedX(coasterCar1Position + 1) - splineSize*.5,
                          mySpline->getComputedY(coasterCar1Position + 1), 
                          mySpline->getComputedZ(coasterCar1Position + 1),
                          0, 1, 0);
		printf("x: %f y: %f z: %f\n", mySpline->getComputedX(coasterCar1Position), 
										mySpline->getComputedY(coasterCar1Position), 
										mySpline->getComputedZ(coasterCar1Position));
