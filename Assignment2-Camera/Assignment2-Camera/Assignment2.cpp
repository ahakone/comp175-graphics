...
int main(int argc, char* argv[])
{
	...
	GLUI_Listbox* cameraListbox = new GLUI_Listbox(camera_panel, "Camera type:", &cameraType);
		cameraListbox->add_item(1, "Perspective");
		cameraListbox->add_item(2, "Orthographic");
